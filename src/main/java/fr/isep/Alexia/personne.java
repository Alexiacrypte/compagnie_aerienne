...
abstract class Personne{
       ...
       protected int Adresse()  {  return adresse;}
       protected int Identifiant()  {  return identifiant;}
       protected int Contact () {  return contact; }

       protected void setNom(String nom) {this.nom = nom;    };
       protected void setAdresse(int adresse)  {this.adresse = adresse;};
